...
class _PlatformCheckboxState extends State<PlatformCheckbox> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    if (Platform.isIOS) {
      ...
      var size = const Size(2 * kRadialReactionRadius + 8.0, 2 * kRadialReactionRadius + 8.0);
...
class _iOSCheckboxRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  @override
  _RenderiOSCheckbox createRenderObject(BuildContext context) => _RenderiOSCheckbox(
    value: value,
    tristate: tristate,
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderiOSCheckbox renderObject) {
    renderObject
      ..value = value
      ..tristate = tristate
      ..activeColor = activeColor
...
const double _kEdgeSize = PlatformCheckbox.width;
const Radius _kEdgeRadius = Radius.circular(16.0);
const double _kStrokeWidth = 1.0;

class _RenderiOSCheckbox extends RenderToggleable {
  _RenderiOSCheckbox({
    bool value,
    bool tristate,
    Color activeColor,
  ...
  RRect _outerRectAt(Offset origin, double t) {
    ...
    final Rect rect = Rect.fromLTWH(
        origin.dx + inset, origin.dy + inset, size, size);
  ...
  Color _colorAt(double t) {
    ...
    return onChanged == null
        ? inactiveColor
        : (t >= 0.25 ? activeColor : Color.lerp(
        inactiveColor, activeColor, t * 4.0));
  }
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final Offset origin = offset +
        (size / 2.0 - const Size.square(_kEdgeSize) / 2.0);
    final AnimationStatus status = position.status;
    final double tNormalized = status == AnimationStatus.forward ||
